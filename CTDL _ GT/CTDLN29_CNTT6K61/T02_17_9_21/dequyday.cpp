...
void sapxep(int *a,int n) //sap xep chen
{
	if(n<=1) return;
	sapxep(a,n-1);
...
int main()
{
	...
	cout<<"n = "; cin>>n;
	nhap(a,n);
	cout<<"\nDay vua nhap "; xuat(a,n);
	cout<<"\nTong : "<<tong(a,n);
	cout<<"\nMax : "<<Max(a,n);
	cout<<"\nMax : "<<MAX(a,1,n);
	cout<<"\nGia tri max : "<<*max_element(a+1,a+n+1);  //tim doc ham max_element
	sapxep(a,n); cout<<"\nDay sau khi sx "; xuat(a,n);
}
